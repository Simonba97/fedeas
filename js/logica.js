var baseMailFactura = '<div style="font-size:16px; line-height:20px; color:#6c6c6c; background:#f2f2f2; padding:0; margin:0; font-family:Arial,sans-serif!important; width:100%!important"> <div style="padding:10px; max-width:400px; font-size:16px; line-height:22px; color:#6c6c6c; background:#f2f2f2; font-family:Arial,sans-serif!important; margin: 0 auto;"> <p style="padding:5px; text-align: center;"><img data-imagetype="External" src="https://i.imgur.com/z141PXF.png" alt="Logo E-DEAS" style="width: 30%;"> </p> <p style="padding:5px"><span style="color:#222; font-weight:bold;">Hola {{nameEmployee}}.</span> <br> <br> {{introduction}} <br> </p> <p style="padding:5px; color:#222; font-weight: bold">Detalle de la deuda actual <span data-markjs="true" class="markrpj0okudo" data-ogac="" data-ogab="" data-ogsc="" data-ogsb="" style="background-color: rgb(255, 241, 0); color: black;">({{total}})</span>: </p> <ul> {{listMouths}} </ul> {{messageAfter}} <span style="font-size:12px; line-height:16px; font-style: italic;">Si esto fue un error o si necesitas ayuda con los valores señalados puedes responder este correo o acercarte a mi estación de trabajo.</span> <br> <p style="padding:5px">Recuerda que puedes realizar el pago de tus aportes mensuales. realizando una transferencia a la cuenta de ahorros <span data-markjs="true" class="markrpj0okudo" data-ogac="" data-ogab="" data-ogsc="" data-ogsb="" style="background-color: rgb(255, 241, 0); color: black;">00849443011</span> de Bancolombia o utilizando el <span data-markjs="true" class="markrpj0okudo" data-ogac="" data-ogab="" data-ogsc="" data-ogsb="" style="background-color: rgb(255, 241, 0); color: black;">código QR</span> que se anexa justo debajo. </p> <p style="padding:5px"> <img data-imagetype="External" src="https://i.imgur.com/SWAyZcz.png" alt="Código QR" style="width: 98%;"> </p> <p style="padding:5px; font-weight: bold; font-style: italic; color: #222"> Gracias. <br> <span style="font-size: 13px;">Simón Bustamante Alzate (Administrador F-EDEAS).</span> </p> </div> </div>';
...
var messageAfter_Deudor = '<p style="padding:5px">Es muy importante que te pongas al dia con tu deuda activa con el fondo, ya que con este dinero se financian actividades de interés común como las celebraciones de los cumpleaños, la finca anual y demás actividades.</p>'

var introductionMessage_Cumplido = 'Te recordamos que ya puedes pagar la cuota del mes que acaba de pasar para así seguir estando al día con F-DEAS, gracias a ti y a tu compromiso son posibles realizar todas las actividades que nos proponemos.'
...
function generate(action) {
    ...
    if (mounthsSelected.length > 0) {
        ...
        //     if (message == 'OK') {
        //         Swal.fire(
        //             `Se envió correctamente la factura de ${nameEmployee}`,
        //             `La factura se envió correctamente al correo: ${mailEmployee}`,
        //             `success`
        //         )
        //         // copyToClipboard(bodyMail);
        //         clearInfo();
        ...
        //         clearInfo();
        //         Swal.fire(
        //             `No se logró enviar la factura a ${nameEmployee}`,
        //             `La factura generada no se pudo enviar por correo a ${nameEmployee} (${mailEmployee}),\nSin embargo se copió en el clipboard para su envio manual`,
        //             `success`
        //         )
        //     }
        // });
